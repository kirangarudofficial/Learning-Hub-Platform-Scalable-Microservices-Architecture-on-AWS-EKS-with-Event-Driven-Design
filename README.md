# Learning Hub Platform - Enterprise-Grade E-Learning System
...
A comprehensive, production-ready learning management system built with modern technologies and enterprise-grade architecture patterns. This platform provides a complete e-learning solution similar to Udemy/Coursera with microservices architecture.
...
- **Assessment Engine**: Quiz and assignment management with grading
...
- **CI/CD Ready**: Jenkins pipelines for automated deployments
- **Monorepo Structure**: Organized codebase with shared libraries
...
│   │   ├── media-service/     # File upload/media
│   │   ├── notification-service/# Notifications
│   │   ├── progress-service/  # Progress tracking
│   │   ├── assessment-service/# Quiz/assignments
...
# Terminal 3: Start specific microservices
cd backend
npm run microservice:user    # User service
npm run microservice:course   # Course service
npm run microservice:enrollment # Enrollment service
```
...
#### Assessment Service
- **Purpose**: Quiz and assignment management
- **Responsibilities**:
...
The project includes comprehensive Jenkins pipelines:

#### Pipeline Files
- `Jenkinsfile.backend` - Backend deployment pipeline
- `Jenkinsfile.frontend` - Frontend deployment pipeline
- `Jenkinsfile.full` - Full stack deployment pipeline
- `Jenkinsfile.service` - Individual microservice deployment

#### Shared Library
- `jenkins-shared-library/` - Reusable pipeline components
- `deployBackend.groovy` - Backend deployment logic
- `deployFrontend.groovy` - Frontend deployment logic
- `deployMicroservices.groovy` - Microservices deployment logic
...
- **Architecture Docs**: See `ARCHITECTURE_SUMMARY.md` and related documentation files
